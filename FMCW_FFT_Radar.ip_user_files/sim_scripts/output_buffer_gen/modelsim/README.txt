...
#
# Generated by export_simulation on Tue Jun 21 09:55:11 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './output_buffer_gen.sh' script.

./output_buffer_gen.sh -reset_run
...
./output_buffer_gen.sh -noclean_files

For more information on the script, please type './output_buffer_gen.sh -help'.
