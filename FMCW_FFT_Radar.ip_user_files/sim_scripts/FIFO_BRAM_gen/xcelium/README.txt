...
#
# Generated by export_simulation on Fri Jun 17 08:14:49 +0200 2022
#
################################################################################
...
'-reset_run' switch to the './FIFO_BRAM_gen.sh' script.

./FIFO_BRAM_gen.sh -reset_run
...
./FIFO_BRAM_gen.sh -noclean_files

For more information on the script, please type './FIFO_BRAM_gen.sh -help'.
